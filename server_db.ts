...
const DEFAULTS: UserRow[] = [
  {
    ...
    first_name: "Gabriel",
    last_name: "Souza",
    email: "gabriel.souza@jiuspeak.com",
  ...
  private load() {
        ...
        this.socialPosts = [
          {
            ...
            likes: ['u2', 'u3'],
            comments: [
              { id: 'c1', user_id: 'u2', name: 'Marcus Miller', content: 'Parabéns mestre Gabriel! Rola impecável e inglês afiado.', created_at: new Date().toISOString() }
            ],
    ...
    try {
      if (fs.existsSync(CARD_COLLECTION_FILE)) {
        ...
        // Clear/initial seed of custom cards for black belt Gabriel
        this.cardCollection = [
          {
            id: 'cc_1',
            user_id: 'u1',
